...
{
    public class Pain113PaymentFile : IInputPaymentFile<PaymentsInitiation001001v03>
    {
        const string pain_namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03";
        Type inputType = typeof(PaymentsInitiation001001v03);
        private PaymentsInitiation001001v03 _isoPayments;
        public PaymentsInitiation001001v03 IsoPayments
        {
        ...
        public int ReadPaymentsFile(string PaymentsFile)
        {
            ...
            try
            {
                ...
                {
                    IsoPayments = getPaymentsInitiationSwift<PaymentsInitiation001001v03>(xmlDoc);
